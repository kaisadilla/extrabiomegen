...
public enum Weirdness {
    ...
    public static Weirdness parse (int value) {
        switch (value) {
            case 0: return NORMAL_OUTER_VALLEY;
            case 1: return NORMAL_OUTER_SLOPE;
            case 2: return NORMAL_PEAK;
            case 3: return NORMAL_INNER_SLOPE;
            case 4: return NORMAL_INNER_VALLEY;
            case 5: return NORMAL_RIVER_BANK;
            case 6: return RIVER_OVERRIDE;
            case 7: return VARIANT_RIVER_BANK;
            case 8: return VARIANT_INNER_VALLEY;
            case 9: return VARIANT_INNER_SLOPE;
            case 10: return VARIANT_PEAK;
            case 11: return VARIANT_OUTER_SLOPE;
            case 12: return VARIANT_OUTER_VALLEY;
            default: return null;
        }
    }
    ...
    public static final Codec<Weirdness> CODEC = Codec.STRING.xmap(
        str -> {
            switch (str) {
                ...
                case "river_override":   return RIVER_OVERRIDE;
